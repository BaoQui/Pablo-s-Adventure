...
@export var dash_cooldown: float = 1.0  # optional cooldown
...
func _physics_process(delta: float) -> void:
	...
	# --- Dash ---
	if Input.is_action_just_pressed("ui_dash") and can_dash and not is_dashing and not is_punching and dash_cooldown_timer <= 0:
